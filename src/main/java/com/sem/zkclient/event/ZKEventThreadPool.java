 ...
 */
package com.sem.zkclient.event;
...
public class ZKEventThreadPool {
	 ...
	 * 并且使用LinkedBlockingQueue无限大小的阻塞队列来处理事件 ZKEventThreadPoolExecutor.
	 * 
	 * @param poolSize
	 */
	public ZKEventThreadPool(Integer poolSize) {
		pool = new ThreadPoolExecutor(poolSize, // corePoolSize 核心线程池大小
